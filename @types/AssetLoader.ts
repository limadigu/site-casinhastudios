...
export class AssetLoader {
    images: Dictionary<HTMLImageElement> = new Dictionary();
    //Properties to help track the assets being loaded
    toLoad: number = 0;
    loaded: number = 0;

    //File extensions for different types of assets
    imageExtensions: string[] = ["png", "jpg", "gif"];
    fontExtensions: string[] = ["ttf", "otf", "ttc", "woff"];
    ...
    loadImage(source: string, loadHandler: { (): void; (this: HTMLImageElement, ev: Event): any; }) {
