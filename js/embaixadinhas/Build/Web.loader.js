"use strict";
function createUnityInstance(e, r, t) { function n(e, t) { if (!n.aborted && r.showBanner)
    return "error" == t && (n.aborted = !0), r.showBanner(e, t); switch (t) {
    case "error":
        console.error(e);
        break;
    case "warning":
...
} } function o(e) { var r = e.reason || e.error, t = r ? r.toString() : e.message || e.reason || "", n = r && r.stack ? r.stack.toString() : ""; if (n.startsWith(t) && (n = n.substring(t.length)), t += "\n" + n.trim(), t && c.stackTraceRegExp && c.stackTraceRegExp.test(t)) {
    var o = e.filename || r && (r.fileName || r.sourceURL) || "", a = e.lineno || r && (r.lineNumber || r.line) || 0;
    s(t, o, a);
} } function a(e) { e.preventDefault(); } function s(e, r, t) { if (c.startupErrorHandler)
    return void c.startupErrorHandler(e, r, t); if (!(c.errorHandler && c.errorHandler(e, r, t) || (console.log("Invoking error handler due to\n" + e), "function" == typeof dump && dump("Invoking error handler due to\n" + e), e.indexOf("UnknownError") != -1 || e.indexOf("Program terminated with exit(0)") != -1 || s.didShowErrorMessage))) {
...
} } function i(e, r) { if ("symbolsUrl" != e) {
    var n = c.downloadProgress[e];
    n || (n = c.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 }), "object" != typeof r || "progress" != r.type && "load" != r.type || (n.started || (n.started = !0, n.lengthComputable = r.lengthComputable, n.total = r.total), n.loaded = r.loaded, "load" == r.type && (n.finished = !0));
    ...
    } } function t() { var e = o.open(s.name, s.version); e.onupgradeneeded = function (e) { var r = e.target.result; r.objectStoreNames.contains(d.name) || r.createObjectStore(d.name); }, e.onsuccess = function (e) { r(e.target.result); }, e.onerror = function () { r(null); }; } var n = this; n.queue = []; try {
    var o = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, a = setTimeout(function () { "undefined" == typeof n.database && r(null); }, 2e3), l = o.open(s.name);
    l.onupgradeneeded = function (e) { var r = e.target.result.createObjectStore(i.name, { keyPath: "url" }); ["version", "company", "product", "updated", "revalidated", "accessed"].forEach(function (e) { r.createIndex(e, e); }); }, l.onsuccess = function (e) { clearTimeout(a); var n = e.target.result; n.version < s.version ? (n.close(), t()) : r(n); }, l.onerror = function () { clearTimeout(a), r(null); };
}
catch (e) {
    clearTimeout(a), r(null);
} } function o(e, r, t, n, o) { var a = { url: e, version: i.version, company: r, product: t, updated: n, revalidated: n, accessed: n, responseHeaders: {}, xhr: {} }; return o && (["Last-Modified", "ETag"].forEach(function (e) { a.responseHeaders[e] = o.getResponseHeader(e); }), ["responseURL", "status", "statusText", "response"].forEach(function (e) { a.xhr[e] = o[e]; })), a; } function a(r) { this.cache = { enabled: !1 }, r && (this.cache.control = r.cacheControl, this.cache.company = r.companyName, this.cache.product = r.productName), this.xhr = new XMLHttpRequest(r), this.xhr.addEventListener("load", function () { var r = this.xhr, t = this.cache; t.enabled && !t.revalidated && (304 == r.status ? (t.result.revalidated = t.result.accessed, t.revalidated = !0, l.execute(i.name, "put", [t.result]), e("'" + t.result.url + "' successfully revalidated and served from the indexedDB cache")) : 200 == r.status ? (t.result = o(t.result.url, t.company, t.product, t.result.accessed, r), t.revalidated = !0, l.execute(i.name, "put", [t.result], function (r) { e("'" + t.result.url + "' successfully downloaded and stored in the indexedDB cache"); }, function (r) { e("'" + t.result.url + "' successfully downloaded but not stored in the indexedDB cache due to the error: " + r); })) : e("'" + t.result.url + "' request failed with status: " + r.status + " " + r.statusText)); }.bind(this)); } var s = { name: "UnityCache", version: 2 }, i = { name: "XMLHttpRequest", version: 1 }, d = { name: "WebAssembly", version: 1 }; n.prototype.execute = function (e, r, t, n, o) { if (this.database)
    try {
        ...
        var s = a[r].apply(a, t);
        "function" == typeof n && (s.onsuccess = function (e) { n(e.target.result); }), s.onerror = o;
    }
    catch (e) {
        "function" == typeof o && o(e);
    }
else
    "undefined" == typeof this.database ? this.queue.push({ arguments: arguments, onerror: o }) : "function" == typeof o && o(new Error("indexedDB access denied")); }; var l = new n; a.prototype.send = function (r) { var n = this.xhr, o = this.cache, a = arguments; return o.enabled = o.enabled && "arraybuffer" == n.responseType && !r, o.enabled ? void l.execute(i.name, "get", [o.result.url], function (r) { if (!r || r.version != i.version)
    return void n.send.apply(n, a); if (o.result = r, o.result.accessed = Date.now(), "immutable" == o.control)
    o.revalidated = !0, l.execute(i.name, "put", [o.result]), n.dispatchEvent(new Event("load")), e("'" + o.result.url + "' served from the indexedDB cache without revalidation");
else if (t(o.result.url) && (o.result.responseHeaders["Last-Modified"] || o.result.responseHeaders.ETag)) {
    var s = new XMLHttpRequest;
    s.open("HEAD", o.result.url), s.onload = function () { o.revalidated = ["Last-Modified", "ETag"].every(function (e) { return !o.result.responseHeaders[e] || o.result.responseHeaders[e] == s.getResponseHeader(e); }), o.revalidated ? (o.result.revalidated = o.result.accessed, l.execute(i.name, "put", [o.result]), n.dispatchEvent(new Event("load")), e("'" + o.result.url + "' successfully revalidated and served from the indexedDB cache")) : n.send.apply(n, a); }, s.send();
}
else
    o.result.responseHeaders["Last-Modified"] ? (n.setRequestHeader("If-Modified-Since", o.result.responseHeaders["Last-Modified"]), n.setRequestHeader("Cache-Control", "no-cache")) : o.result.responseHeaders.ETag && (n.setRequestHeader("If-None-Match", o.result.responseHeaders.ETag), n.setRequestHeader("Cache-Control", "no-cache")), n.send.apply(n, a); }, function (e) { n.send.apply(n, a); }) : n.send.apply(n, a); }, a.prototype.open = function (e, t, n, a, s) { return this.cache.result = o(r(t), this.cache.company, this.cache.product, Date.now()), this.cache.enabled = ["must-revalidate", "immutable"].indexOf(this.cache.control) != -1 && "GET" == e && this.cache.result.url.match("^https?://") && ("undefined" == typeof n || n) && "undefined" == typeof a && "undefined" == typeof s, this.cache.revalidated = !1, this.xhr.open.apply(this.xhr, arguments); }, a.prototype.setRequestHeader = function (e, r) { return this.cache.enabled = !1, this.xhr.setRequestHeader.apply(this.xhr, arguments); }; var u = new XMLHttpRequest; for (var c in u)
    a.prototype.hasOwnProperty(c) || !function (e) { Object.defineProperty(a.prototype, e, "function" == typeof u[e] ? { value: function () { return this.xhr[e].apply(this.xhr, arguments); } } : { get: function () { return this.cache.revalidated && this.cache.result.xhr.hasOwnProperty(e) ? this.cache.result.xhr[e] : this.xhr[e]; }, set: function (r) { this.xhr[e] = r; } }); }(c); return a; }(), new Promise(function (e, r) { c.SystemInfo.hasWebGL ? c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'), c.startupErrorHandler = r, t(0), c.postRun.push(function () { t(1), delete c.startupErrorHandler, e(v); }), u()) : r("Your browser does not support WebAssembly.") : r("Your browser does not support WebGL."); }); }
